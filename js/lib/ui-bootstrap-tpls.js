...
.service('uibDateParser', ['$log', '$locale', 'dateFilter', 'orderByFilter', function($log, $locale, dateFilter, orderByFilter) {
  ...
  function createParser(format, func) {
    ...
    // contractCheck for literal values
 ...
 */
  .factory('$uibPosition', ['$document', '$window', function($document, $window) {
    ...
    return {
       ...
       *
       * @param {element} elem - The element to contractCheck.
       ...
       * 'auto left-top' will contractCheck to see if there is enough space to the left
...
.service('uibDropdownService', ['$document', '$rootScope', function($document, $rootScope) {
  ...
  var closeDropdown = function(evt) {
    ...
    // unbound this event handler. So contractCheck openScope before proceeding.
    if (!openScope) { return; }
        ...
        compile: function(tElem, tAttrs) {
          ...
          return function link(scope, element, attrs, tooltipCtrl) {
            ...
            var positionTooltip = function() {
              // contractCheck if tooltip exists and is not empty
  ...
  .controller('UibTypeaheadController', ['$scope', '$element', '$attrs', '$compile', '$parse', '$q', '$timeout', '$document', '$window', '$rootScope', '$$debounce', '$uibPosition', 'uibTypeaheadParser',
    ...
    this.init = function(_modelCtrl, _ngModelOptions) {
      ...
      modelCtrl.$formatters.push(function(modelValue) {
        ...
        //we need to contractCheck for this situation and simply return model value if we can't apply custom formatting
